...
def predict_result(datas=None):
    ...
    model.load_state_dict(torch.load("23classification2.pth", map_location='cpu'))
...
if __name__ == '__main__':
    ...
    data = [18114.703243270982, 1337.2019510874525, 5006.928658325225, 4989.230273844674, 1854.1111520813429,
            ...
            -0.0556522508659626, -0.5145220751468748, -0.7812298025557365, -0.900114476102391, 0.9611478908253382,
            0.3495203204957407, 0.826071285700574, -0.8430192651728674, -0.8334670851415399, 0.42622085027801004,
